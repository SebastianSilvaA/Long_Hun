import HeaderWithVideo from "@/components/primary/TorneoHeader";
    ...
    <>
      ...
      <div className="mb-6 text-white lg:text-3xl">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>Formas por equipo: 20.000</li>
          <li>ENTRADAS GENERALES: 2.000</li>
          <li>ANTICIPADAS EN EL LUGAR: 2.500</li>
        </ul>
      </div>
      </div>
      ...
      <div className="mb-6 text-white lg:text-3xl">
        ...
        <div>
          ...
          <ul className="list-disc list-inside">
            <li>Cabezal o casco.</li>
            <li>Guantes.</li>
            <li>En caso de usar zapatillas, deben ser las reglamentarias.</li>
            <li>Protector bucal.</li>
            <li>Protector inguinal masculino y femenino.</li>
            <li>Protector de pecho femenino.</li>
            <li>Canilleras o espinilleras.</li>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>En caso de usar zapatillas, deben ser las reglamentarias.</li>
            <li>
              Habiendo coach, luego de la primera advertencia, la segunda será
              contabilizada como punto en contra.
            </li>
          </ul>
          ...
          <p className="">
            ...
            un competidor dentro del tatami y este producto de la acción sale
            del área de combate, el o los puntos son válidos, ya que fue hecha
            la marcación de puntos dentro del área de combate. Por el
            contrario, si un atleta marca un punto fuera del área no se sumará
            la técnica a favor.
          </p>
          ...
          <ul className="list-disc list-inside">
            <li>
              Una (1) amonestación de haber un empate al final del combate,
              determinará como perdedor al competidor amonestado.
            </li>
            <li>
              Dos (2) amonestaciones en un mismo combate, será causal de un
              punto menos para el competidor penalizado.
            </li>
            <li>
              Tres (3) amonestaciones en un mismo combate, será causal de
              descalificación para el competidor penalizado.
            </li>
          </ul>
          ...
          <p className="text-white">
            ...
            por parte de algún atleta, coach, entrenador, árbitro y personas en
            general, considerada una grave falta de respeto al evento, a los
            competidores o al público presente, el atleta o involucrado será
          ...
          <p className="text-white">
            ...
            estar en el área como así hablar con el 4° juez de ser necesario,
            desde principiantes a cintas negras. El Coach deberá tramitar con
